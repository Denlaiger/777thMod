	...
	class TripSeventh_M56R_Vest_Meatshield : TripSeventh_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[777th] M56R Armor (Meatshield)";
	...
	hiddenSelectionsTextures[]= { 
		...
		"TripSeventh_Armor_Misriah_Named\data\Meatshield\777th_Meatshield_Upper_Armor.paa",
	...
	class TripSeventh_M56_ODST_Helmet_Meatshield : TripSeventh_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[777th] M56-R Helmet (Meatshield)";
		model="MA_Armor\data\Helmets\HR_ODST\HR_ODST.p3d";
		picture="MA_Armor\data\Icons\Halo_Reach_ODST_Helmet.paa";
		hiddenSelectionsTextures[]= { 
			"TripSeventh_Armor_Misriah_Named\data\Meatshield\777th_ODST_Helm.paa",
