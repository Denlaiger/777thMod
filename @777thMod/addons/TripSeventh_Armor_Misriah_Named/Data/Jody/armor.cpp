	...
	class TripSeventh_M56R_Vest_Jody : TripSeventh_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[777th] M56R Armor (Jody)";
	...
	hiddenSelectionsTextures[]= { 
		...
		"TripSeventh_Armor_Misriah_Named\data\Jody\777th_Jody_Upper_Armor.paa",
		"TripSeventh_Armor_Misriah_Named\data\Jody\777th_Jody_Lower_Armor.paa",
	...
	class TripSeventh_M56_ODST_Helmet_Jody : TripSeventh_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[777th] M56-R Helmet (Jody)";
		model="MA_Armor\data\Helmets\HR_ODST\HR_ODST.p3d";
		picture="MA_Armor\data\Icons\Halo_Reach_ODST_Helmet.paa";
		hiddenSelectionsTextures[]= { 
			"TripSeventh_Armor_Misriah_Named\data\Jody\777th_Jody_Helm.paa",
			"TripSeventh_Armor_Misriah_Named\data\Jody\777th_Jody_Custom_Visor.paa"
		};
		class ItemInfo: ItemInfo {
