	...
	class TripSeventh_M56R_Vest_Nightmare : TripSeventh_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[777th] M56R Armor (Nightmare)";
	...
	hiddenSelectionsTextures[]= { 
		...
		"TripSeventh_Armor_Misriah_Named\data\Nightmare\777th_Nightmare_Upper_Armor.paa",
		"TripSeventh_Armor_Misriah_Named\data\Nightmare\777th_Nightmare_Lower_Armor.paa",
	...
	class TripSeventh_M56_ODST_Helmet_Nightmare : TripSeventh_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[777th] M56-R Helmet (Nightmare)";
		model="MA_Armor\data\Helmets\HR_ODST\HR_ODST.p3d";
		picture="MA_Armor\data\Icons\Halo_Reach_ODST_Helmet.paa";
		hiddenSelectionsTextures[]= { 
			"TripSeventh_Armor_Misriah_Named\data\Nightmare\777th_Nightmare_Helmet.paa",
