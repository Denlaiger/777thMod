	...
	class TripSeventh_M56R_Vest_Grimgnaw : TripSeventh_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[777th] M56R Armor (Grimgnaw)";
	...
	hiddenSelectionsTextures[]= { 
		...
		"TripSeventh_Armor_Misriah_Named\data\Grimgnaw\777th_Grimgnaw_Upper_Armor.paa",
		...
		"TripSeventh_Armor_Misriah_Named\data\Grimgnaw\777th_Grimgnaw_Sniper_Shoulders.paa", 
	...
	class TripSeventh_M56_Scout_Helmet_Grimgnaw : TripSeventh_M56_Scout_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[777th] M56-S Helmet (Grimgnaw)";
		model="MA_Armor\data\Helmets\H4_Scout\H4_Scout_Helmet.p3d";
		picture="MA_Armor\data\Icons\H4_Scout_Helmet.paa";
		hiddenSelectionsTextures[]= { 
			"TripSeventh_Armor_Misriah_Named\data\Grimgnaw\777th_Grimgnaw_Scout_Helm.paa",
