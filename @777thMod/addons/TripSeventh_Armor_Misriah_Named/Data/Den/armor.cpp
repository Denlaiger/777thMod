	...
	class TripSeventh_M56R_Vest_Den : TripSeventh_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[777th] M56R Armor (Den)";
	...
	hiddenSelectionsTextures[]= { 
		...
		"TripSeventh_Armor_Misriah_Named\data\Den\777th_Den_Upper_Armor.paa",
		"777thArmour\Data\777th_Lower_Armor.paa",
		//"MA_Armor\data\Vests\Reach_ODST\Reach_Armor_Lower_co.paa",
		"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa", 
		"TripSeventh_Armor_Misriah_Named\data\Den\777th_Den_Custom_Arm_Vents.paa",
	...
	class TripSeventh_M56_Scout_Helmet_Den : TripSeventh_M56_Scout_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[777th] M56-S Helmet (Den)";
		model="MA_Armor\data\Helmets\H4_Scout\H4_Scout_Helmet.p3d";
		picture="MA_Armor\data\Icons\H4_Scout_Helmet.paa";
		hiddenSelectionsTextures[]= { 
			"TripSeventh_Armor_Misriah_Named\data\Den\777th_Scout_Helm.paa",
			//"MA_Armor\data\Helmets\H4_Scout\Scout_Visor_Black_co.paa"
			"MA_Armor\data\Helmets\H4_Scout\Scout_Visor_Gold_co.paa"
		};
		class ItemInfo: ItemInfo {
