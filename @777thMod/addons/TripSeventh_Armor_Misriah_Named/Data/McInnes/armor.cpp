	...
	class TripSeventh_M56R_Vest_McInnes : TripSeventh_Vest_Base {
	scope=2;
	scopeArsenal=2;
	displayName="[777th] M56R Armor (McInnes)";
	...
	hiddenSelectionsTextures[]= { 
		...
		"TripSeventh_Armor_Misriah_Named\data\McInnes\777th_McInnes_Upper_Armor.paa",
		"TripSeventh_Armor_Misriah_Named\data\McInnes\777th_McInnes_Lower_Armor.paa",
	...
	class TripSeventh_M56_ODST_Helmet_McInnes : TripSeventh_M56SR_Helmet {
		scope=2;
		scopeArsenal=2;
		displayName="[777th] M56-R Helmet (McInnes)";
		model="MA_Armor\data\Helmets\HR_ODST\HR_ODST.p3d";
		picture="MA_Armor\data\Icons\Halo_Reach_ODST_Helmet.paa";
		hiddenSelectionsTextures[]= { 
			"TripSeventh_Armor_Misriah_Named\data\McInnes\777th_McInnes_Helmet.paa",
			"TripSeventh_Armor_Misriah_Named\data\McInnes\777th_McInnes_Custom_Visor.paa"
		};
		class ItemInfo: ItemInfo {
